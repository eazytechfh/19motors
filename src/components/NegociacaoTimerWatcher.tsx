    ...
    <>
          ...
          <div className="overflow-hidden rounded-xl border border-gray-200 bg-card shadow-lg dark:border-gray-800">
            <div className="flex items-center justify-between border-b border-gray-100 px-4 py-3 dark:border-gray-800">
              ...
              <button
                ...
                className="rounded p-1 text-gray-500 hover:bg-gray-100 hover:text-gray-600 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-300"
                title="Minimizar"
              >
                &#8211;
              </button>
            ...
            <div className="max-h-80 overflow-y-auto">
              {negociacoesOrdenadas.length === 0 ? (
                <p className="px-4 py-6 text-center text-xs text-gray-500 dark:text-gray-400">Nenhuma negociação ativa.</p>
              ) : (
      ...
      {leadSelecionado && (
        <LeadDrawer
          ...
          onDeleted={(leadId) => {
            setNegociacoes((prev) => prev.filter((lead) => lead.id !== leadId));
