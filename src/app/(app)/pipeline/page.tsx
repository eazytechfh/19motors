...
// Os slugs válidos vêm de pipeline_etapas. Etapas legadas aparecem apenas para leitura e não
// aceitam novos cards, evitando que um valor fora da configuração seja persistido.
...
export default function PipelinePage() {
  ...
  async function moverLead(
    ...
    const followManual = entrandoEmFollowUp ? 'ativo' : 'inativo';
      ...
      prev.map((l) =>
        l.id === leadId
          ? {
              ...
              ...(entrandoEmFollowUp ? { ja_recebeu_msg: null, erro_follow_manual: null } : {}),
            }
          : l
      )
    );
