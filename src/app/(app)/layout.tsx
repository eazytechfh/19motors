...
import { LeadAssignmentSoundWatcher } from '@/components/LeadAssignmentSoundWatcher';
...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      {userData.user && userCargo === 'vendedor' && (
        <LeadAssignmentSoundWatcher vendedor={userName} />
      )}
    </div>
  );
}
